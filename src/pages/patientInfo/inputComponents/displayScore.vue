<template>
  <div class="score_container">
    ...
    <span style="color:rgb(35, 149, 247);width:20px;display:inline-block;margin-right:10px;">
      {{report.value || '0.00'}}
    ...
    <mt-button class="score_button" type="primary" plain @click.native="jumpScorePage">评分</mt-button>
    <mt-popup
      class="score_mask"
    ...
    <div class="header-fixed" v-show="item.baseProperty.scoreInfo.scoreStatus">
      ...
      <score-pasi ref="pasi" v-if="item.baseProperty.scoreInfo.scoreName == 'PASI'&&item.baseProperty.scoreInfo.scoreStatus" :item="item" :report="report" @callback-data="callbackData"></score-pasi>
      <score-pga ref="pasi" v-if="item.baseProperty.scoreInfo.scoreName == 'PGA'&&item.baseProperty.scoreInfo.scoreStatus" :item="item" :report="report" @callback-data="callbackData"></score-pga>
