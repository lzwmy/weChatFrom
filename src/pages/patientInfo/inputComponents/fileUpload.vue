<template>
    <div class="fileUpload" style="display:flex;padding:5px 0">
        <!-- <mt-field 
            label="上传图片:">
        </mt-field> -->
        <span v-if="item.displayIsVisible=='1'">{{item.controlDisplayName}}：</span>
        <!-- {{item.baseProperty.labelImage}} -->
        <img v-else-if="item.baseProperty.labelImage!=''" :src="baseURL+`research/file/downloadFile/${item.baseProperty.labelImage}`" style="height:100px;"></img>
        <ul>
